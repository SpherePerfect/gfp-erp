                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-2">
                  <AnimatePresence mode="popLayout">
                    {currentList.map((item, index) => {
                      ...
                      return (
                        <motion.div
                          key={`${activeCategoryKey}-${item}-${index}`}
                          layout
                          initial={{ opacity: 0, y: 8, scale: 0.98 }}
                          animate={{ opacity: 1, y: 0, scale: 1 }}
                          exit={{ opacity: 0, scale: 0.95, y: -6, transition: { duration: 0.15 } }}
                          transition={{ type: 'spring', stiffness: 450, damping: 32 }}
                          className="bg-white border border-slate-200/90 hover:border-slate-300 rounded-2xl p-3 flex items-center justify-between gap-3 shadow-sm group transition-all"
                        >
                            ...
                            {isEditing ? (
                              ...
                              <>
                                <button
                                  ...
                                  className="px-2 py-1 text-[11px] font-medium text-slate-500 hover:text-slate-800 hover:bg-slate-100 rounded-lg transition-colors opacity-80 group-hover:opacity-100"
                                >
                                  Rename
                                </button>
                                <button
                                  ...
                                  className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 disabled:opacity-30 rounded-lg transition-colors"
                                >
